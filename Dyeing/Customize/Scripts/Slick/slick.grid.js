...
(function ($) {
    ...
    function SlickGrid(container, data, columns, options) {
        ...
        var $headerScroller;
        var $headers;
        var $headerRow, $headerRowScroller, $headerRowSpacer, $footerRow, $footerRowScroller;
        ...
        function init() {
            ...
            $footerRowScroller = $("<div class='slick-headerrow ui-state-default' style='overflow:hidden;position:relative;' />").appendTo($container);
        ...
        function createColumnHeaders() {
            ...
            for (var i = 0; i < columns.length; i++) {
                ...
                if (options.showFooterRow) {
                    var footerRowCell = $("<div class='ui-state-default slick-headerrow-column l" + i + " r" + i + "'></div>")
                        .data("column", m)
                        .appendTo($footerRow);
