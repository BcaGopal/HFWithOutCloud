...
namespace Service
{
    public interface ITasksService : IDisposable
    {
        ...
        /// </summary>
        /// <param name="id">PrimaryKey of Task</param>
        /// <param name="UserName">Current User</param>
        /// <returns></returns>
        Task NotifyUser(int id,string UserName);
    }
    ...
    public class TasksService : ITasksService
    {
        ...
        public TasksService(IRepository<Tasks> TaskRepository, IUnitOfWork unitofwork)
        {
        ...
        public async Task NotifyUser(int id,string UserName)//TaskId
        {
            TasksViewModel vmTasks = FindViewModel(id);
            ...
            objNotification.CreatedBy = UserName;
            ...
            NotificationSave nc = new NotificationSave();

            await nc.SaveNotificationAsync (objNotification, vmTasks.ForUser);
