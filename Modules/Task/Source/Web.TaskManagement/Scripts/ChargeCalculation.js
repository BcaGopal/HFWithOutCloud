...
function AddCalculationFields(DocHeaderId, DebugMode, CalculationId, HeaderCTable, LineCTable, MaxLinId) {
    ...
    $.ajax({
        ...
        data: { HeaderId: DocHeaderId, CalculationId: CalculationId, LineChargeTable: LineCTable, MaxLineId: MaxLinId },
    ...
    $.ajax({
        ...
        data: { HeaderId: DocHeaderId, CalculationId: CalculationId, HeaderChargeTable: HeaderCTable, LineChargeTable: LineCTable },
        success: function (data) {
            FooterFields = data;
