...
var StockInHandGroupOnConstants = {
...
function CustomSelectFunctionForStockIn(ElementId, GetAction, SetAction, placehold, IsMultiple, MinLength, StockHeaderId, ProductId, Dimension1Id, Dimension2Id, Dimension3Id, Dimension4Id) {
    var geturl = GetAction;
    //The url we will send our get request to
    var attendeeUrl = GetAction;
    var pageSize = 20;
