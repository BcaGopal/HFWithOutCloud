              ...
              success: function (result) {
                  ...
                  if (result.Success == true) {
                    ...
                    //  $scope.gridOptions.columnDefs.push({ field: 'CostCenterId', width: 50, visible: false });
                      ...
                      $scope.gridOptions.columnDefs.push({ name: 'Balance Qty', field: 'BalQty', enableFiltering: true, type: 'number', width: 100, visible: true, cellClass: 'cell-text', headerCellClass: 'header-text', enableCellEdit: true, enableCellEditOnFocus: true, validators: { required: true, datatype: 'int' }, });
                      $scope.gridOptions.columnDefs.push({ name: 'Consume Qty', field: 'ConsumeQty', enableFiltering: true, type: 'number', width: 100, visible: false, cellClass: 'cell-text', headerCellClass: 'header-text', enableCellEdit: true, enableCellEditOnFocus: true, validators: { required: true, datatype: 'int' }, });
                      $scope.gridOptions.columnDefs.push({ field: 'LotNo', width: 70, visible: true, cellClass: 'cell-text-c', headerCellClass: 'header-text', enableCellEdit: false });
                      $scope.gridOptions.columnDefs.push({ field: 'PlanNo', width: 70, visible: true, cellClass: 'cell-text-c', headerCellClass: 'header-text', enableCellEdit: false })
                      $scope.gridOptions.columnDefs.push({ field: 'UnitName', width: 70, visible: true, cellClass: 'cell-text-c', headerCellClass: 'header-text', enableCellEdit: false, enableFiltering: true });
