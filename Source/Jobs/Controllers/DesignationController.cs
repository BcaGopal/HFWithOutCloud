...
{
    [Authorize]
    public class DesignationController : System.Web.Mvc.Controller
    {
        ...
        {          
            var vm = _DesignationService.GetDesignationList();
            return View(vm);
        }
        ...
        {
            var DocType = new DocumentTypeService(_unitOfWork).FindByName(MasterDocTypeConstants.Designation);
            int DocTypeId = 0;

            if (DocType != null)
                DocTypeId = DocType.DocumentTypeId;
            else
                return View("~/Views/Shared/InValidSettings.cshtml").Warning("Document Type named " + MasterDocTypeConstants.Designation + " is not defined in database.");
            ...
            Designation vm = new Designation();
            vm.IsActive = true;
        ...
        public ActionResult Edit(int id)
        {
            ...
            Designation pt = _DesignationService.Find(id);
            if (pt == null)
            {
                return HttpNotFound();
            }
        ...
        public ActionResult Delete(int id)
        {
            ...
            Designation Designation = _DesignationService.Find(id);
            if (Designation == null)
            {
                return HttpNotFound();
            }
        ...
        {
            var nextId = _DesignationService.NextId(id);
            return RedirectToAction("Edit", new { id = nextId });
        }
        [HttpGet]
        public ActionResult PrevPage(int id)//CurrentHeaderId
        {
            var nextId = _DesignationService.PrevId(id);
            return RedirectToAction("Edit", new { id = nextId });
        }
