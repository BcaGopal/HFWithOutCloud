...
{
    [Authorize]
    public class ProductMapController : System.Web.Mvc.Controller
    {
        ...
        public ProductMapController(IProductService ProductService, IFinishedProductService FinishedProductService, IUnitOfWork unitOfWork, IExceptionHandlingService exec)
        {
