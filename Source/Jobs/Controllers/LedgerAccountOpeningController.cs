...
namespace Jobs.Controllers
{
    ...
    [Authorize]
    public class LedgerAccountOpeningController : System.Web.Mvc.Controller
    {
        private ApplicationDbContext db = new ApplicationDbContext();
        ILedgerAccountOpeningService _LedgerAccountOpeningService;
        ...
        {
            var p = _LedgerAccountOpeningService.GetLedgerAccountOpeningListForIndex(id).ToList();                               
        ...
        public ActionResult Delete(int id)//LedgerHeaderId
        {
            ...
            LedgerAccountOpeningViewModel LedgerAccountOpening = _LedgerAccountOpeningService.GetLedgerAccountOpeningForEdit(id);
            if (LedgerAccountOpening == null)
            {
                return HttpNotFound();
            }
            PrepareViewBag();
            return View(LedgerAccountOpening);
        }
