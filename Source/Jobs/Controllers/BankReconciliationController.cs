...
{
    [Authorize]
    public class BankReconciliationController : System.Web.Mvc.Controller
    {
        ...
        public BankReconciliationController(IUnitOfWork unitOfWork, IExceptionHandlingService exec)
        {
            _exception = exec;
        ...
        public JsonResult LedgerAccountLedgerList(BankReconciliationFilterArgs Fvm)//LedgerAccountId
        {
            ...
            var list = (from L in db.Ledger
                        where L.LedgerAccountId == Fvm.LedgerAccountId
                        ...
                        select new BankReconciliationViewModel
                        {
                            ...
                            Narration = L.LedgerHeader.Narration,
                            ChqNo = L.ChqNo,
                            ChqDate = L.ChqDate,
                            AmtDr = L.AmtDr,
                            AmtCr = L.AmtCr,
        ...
        public ActionResult UpdateBankDate(int LedgerId, DateTime? BankDate)
        {
        ...
        //public ActionResult ConfirmProdOrderList(List<BankReconciliationViewModel> Selected, int id)
        //{
        ...
        //    if (!BarCodesBased)
        //        return Json(new { Success = "URL", Data = "/BankReconciliation/Create/" + id.ToString() }, JsonRequestBehavior.AllowGet);
        //    else
        //        return Json(new { Success = "URL", Data = "/BankReconciliation/FirstBarCode/" + id.ToString() }, JsonRequestBehavior.AllowGet);
        //}
        ...
        //{
        //    List<BankReconciliationViewModel> ProdOrders = (List<BankReconciliationViewModel>)System.Web.HttpContext.Current.Session["BarCodesWeavingWizardProdOrder"];

        //    BankReconciliationMasterDetailModel vm = new BankReconciliationMasterDetailModel();
        ...
        //    vm.BankReconciliationViewModel = ProdOrders;
        ...
        //[HttpPost]
        //public ActionResult FirstBarCodePost(BankReconciliationMasterDetailModel vm)
        //{
        //    BankReconciliationMasterDetailModel MasterDetailModel = new BankReconciliationMasterDetailModel();
        //    List<BankReconciliationViewModel> List = new List<BankReconciliationViewModel>();

        //    foreach (var item in vm.BankReconciliationViewModel)
        //    {

        //        BankReconciliationViewModel Wizard = new BankReconciliationViewModel();
        ...
        //    MasterDetailModel.BankReconciliationViewModel = List;
        ...
        //[ValidateAntiForgeryToken]
        //[HttpPost]
        //public ActionResult BarCodeSequencePost(BankReconciliationMasterDetailModel vm)
        //{

        //    System.Web.HttpContext.Current.Session["BarCodesWeavingWizardProdOrder"] = vm.BankReconciliationViewModel;

        //    return RedirectToAction("Create", new { id = vm.BankReconciliationViewModel.FirstOrDefault().DocTypeId });
        ...
        //    var ProdOrderLin = ((List<BankReconciliationViewModel>)System.Web.HttpContext.Current.Session["BarCodesWeavingWizardProdOrder"]).FirstOrDefault();
        ...
        //    var Lines = (List<BankReconciliationViewModel>)System.Web.HttpContext.Current.Session["BarCodesWeavingWizardProdOrder"];
        ...
        //    List<BankReconciliationViewModel> ProdOrdersAndQtys = (List<BankReconciliationViewModel>)System.Web.HttpContext.Current.Session["BarCodesWeavingWizardProdOrder"];
