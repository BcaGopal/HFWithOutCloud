...
{
    [Authorize]
    public class FinishingOrderCancelTextImportController : System.Web.Mvc.Controller
    {
        private ApplicationDbContext db = new ApplicationDbContext();

        IUnitOfWork _unitOfWork;

        public FinishingOrderCancelTextImportController(IUnitOfWork unitOfWork)
        {
        ...
        {
            return Redirect(System.Configuration.ConfigurationManager.AppSettings["JobsDomain"] + "/" + "JobOrderCancelHeader" + "/" + "Index" + "/" + id);
        }
