...
{
    [Authorize]
    public class ProductSizeTypeController : System.Web.Mvc.Controller
    {
        private ApplicationDbContext db = new ApplicationDbContext();

        ActiivtyLogViewModel LogVm = new ActiivtyLogViewModel();

        IProductSizeTypeService _ProductSizeTypeService;
        IUnitOfWork _unitOfWork;
        IExceptionHandlingService _exception;
        public ProductSizeTypeController(IProductSizeTypeService ProductSizeTypeService, IUnitOfWork unitOfWork, IExceptionHandlingService exec)
        {
            _ProductSizeTypeService = ProductSizeTypeService;
        ...
        {
            var ProductSizeType = _ProductSizeTypeService.GetProductSizeTypeList().ToList();
            return View(ProductSizeType);
        }
        ...
        public ActionResult DeleteConfirmed(ReasonViewModel vm)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                var temp = _ProductSizeTypeService.Find(vm.id);
                ...
                _ProductSizeTypeService.Delete(vm.id);
                XElement Modifications = new ModificationsCheckService().CheckChanges(LogList);
                try
                {
                    _unitOfWork.Save();
        ...
        {
            var nextId = _ProductSizeTypeService.NextId(id);
            return RedirectToAction("Edit", new { id = nextId });
        }
        [HttpGet]
        public ActionResult PrevPage(int id)//CurrentHeaderId
        {
            var nextId = _ProductSizeTypeService.PrevId(id);
            return RedirectToAction("Edit", new { id = nextId });
        }
