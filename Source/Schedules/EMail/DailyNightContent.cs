...
namespace EmailContents
{
    ...
    public class DailyNightContent
    {
        ...
        public void SendEMail()
        {
            ...
            try
            {
                ...
                {
                    writer.WriteLine("Calling Daily Night Event", DateTime.Now);
                    writer.Close();
                }
            }
            catch (Exception x)
            ...
            using (SqlConnection sqlConnection = new SqlConnection(ConfigurationManager.ConnectionStrings["DefaultConnection"].ConnectionString.ToString()))
            {
                ...
                SqlDataAdapter sqlDataAapter = new SqlDataAdapter("Web.spEMail_DailyNight", sqlConnection);
