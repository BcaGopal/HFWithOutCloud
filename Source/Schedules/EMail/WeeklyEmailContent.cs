...
{
    public class WeeklyEmailContent
    {
        ...
        public void SendEMail()
        {
            ...
            try
            {
                ...
                {
                    writer.WriteLine("Calling Weekly Email Event", DateTime.Now);
                    writer.Close();
                }
            }
            catch (Exception x)
            ...
            using (SqlConnection sqlConnection = new SqlConnection(ConfigurationManager.ConnectionStrings["DefaultConnection"].ConnectionString.ToString()))
            {
                ...
                SqlDataAdapter sqlDataAapter = new SqlDataAdapter("Web.spEMail_Weekly", sqlConnection);
