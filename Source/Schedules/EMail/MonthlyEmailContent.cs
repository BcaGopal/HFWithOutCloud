...
{
    public class MonthlyEmailContent
    {
        ...
        public void SendEMail()
        {
            ...
            try
            {
                ...
                {
                    writer.WriteLine("Calling Monthly Email Event", DateTime.Now);
                    writer.Close();
                }
            }
            catch (Exception x)
            ...
            using (SqlConnection sqlConnection = new SqlConnection(ConfigurationManager.ConnectionStrings["DefaultConnection"].ConnectionString.ToString()))
            {
                ...
                SqlDataAdapter sqlDataAapter = new SqlDataAdapter("Web.spEMail_Monthly", sqlConnection);
