...
/****** Object:  StoredProcedure [Web].[spRep_WeavingMaterialIssueReport]    Script Date: 26/Aug/2015 5:21:08 PM ******/

IF object_id ('[Web].[spRep_WeavingMaterialIssueReport]') IS NOT NULL 
 DROP Procedure  [Web].[spRep_WeavingMaterialIssueReport]
GO
/****** Object:  StoredProcedure [Web].[spRep_WeavingMaterialIssueReport]    Script Date: 26/Aug/2015 5:21:08 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE PROCEDURE  [Web].[spRep_WeavingMaterialIssueReport]
			...
			select 
				 ...
				 sum(IsNull(L.Qty_Iss,0)) AS StockQty,
				 max(IsNull(U.DecimalPlaces,0)) AS DecimalPlaces,
				 'WeavingMaterialIssueSummary.rdl' AS ReportName,'Material Issue For Weaving Report' AS ReportTitle, NULL AS SubReportProcList,
