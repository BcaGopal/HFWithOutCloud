...
/****** Object:  StoredProcedure [Web].[spRep_JobReceiveBalanceSummary]    Script Date: 04/Aug/2015 12:21:54 PM ******/

IF OBJECT_ID ('[Web].[spRep_JobReceiveBalanceSummary]') IS NOT NULL
	DROP PROCEDURE [Web].[spRep_JobReceiveBalanceSummary]	
GO
...
CREATE PROCEDURE [Web].[spRep_JobReceiveBalanceSummary]
...
'Job Receive Balance Summery' AS ReportTitle, NULL AS SubReportProcList,'JobReceiveBalanceSummary.rdl' AS ReportName
