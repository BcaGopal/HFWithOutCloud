...
/****** Object:  StoredProcedure [Web].[spRep_PurchaseGoodsReceiveSummary_Carpet]    Script Date: 04/Aug/2015 2:09:01 PM ******/

IF OBJECT_ID ('[Web].[spRep_PurchaseGoodsReceiveSummary_Carpet]') IS NOT NULL
	DROP PROCEDURE [Web].[spRep_PurchaseGoodsReceiveSummary_Carpet]	
GO
...
CREATE PROCEDURE [Web].[spRep_PurchaseGoodsReceiveSummary_Carpet]
	...
	Sum(L.Qty*(CASE WHEN @AreaOnUnit = 'Sq.Yard' THEN Ra.SqYardPerPcs ELSE Ra.Area END)) AS TotalArea,
	...
	'PurchaseGoodsReceiveSummary_Carpet.rdl' AS ReportName, 'Carpet Purchase Goods Receive Summary' AS ReportTitle, NULL AS SubReportProcList	
	FROM
	(
