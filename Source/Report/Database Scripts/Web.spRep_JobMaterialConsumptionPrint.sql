...
/****** Object:  StoredProcedure [Web].[spRep_JobMaterialConsumptionPrint]    Script Date: 13/Jul/2015 2:23:15 PM ******/

IF OBJECT_ID ('[Web].[spRep_JobMaterialConsumptionPrint]') IS NOT NULL
	DROP PROCEDURE [Web].[spRep_JobMaterialConsumptionPrint]
GO
...
CREATE Procedure  [Web].[spRep_JobMaterialConsumptionPrint] (@Id INT)
As
BEGIN
...
CASE WHEN @Dimension1IdCnt > 0 AND @Dimension2IdCnt = 0 THEN D1.Dimension1Name
  ...
  CASE WHEN @Dimension1IdCnt > 0 AND @Dimension2IdCnt > 0 THEN 'JobMaterialConsumptionPrint_DoubleDimension.rdl'
	 	 WHEN @Dimension1IdCnt > 0 AND @Dimension2IdCnt = 0 THEN 'JobMaterialConsumptionPrint_SingleDimension.rdl'
	 	 WHEN @Dimension1IdCnt = 0 AND @Dimension2IdCnt > 0 THEN 'JobMaterialConsumptionPrint_SingleDimension.rdl'
	 	 WHEN @Dimension1IdCnt = 0 AND @Dimension2IdCnt = 0 THEN 'JobMaterialConsumptionPrint.rdl'
