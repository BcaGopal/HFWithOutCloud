...
/****** Object:  StoredProcedure [Web].[spRep_MaterialIssueSummary]    Script Date: 24/Aug/2015 3:09:08 PM ******/
...
SELECT
	 ...
	 IsNull(Sum(L.Qty),0) AS StockQty,IsNull(Max(U.DecimalPlaces),0) AS DecimalPlaces,
