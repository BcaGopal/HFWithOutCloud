...
{
    public class PurchaseOrderInspectionHeader : EntityBase, IHistoryLog
    {
        ...
        [ForeignKey("DocType")]
        [Index("IX_PurchaseOrderInspectionHeader_DocID", IsUnique = true, Order = 1)]
        ...
        [Index("IX_PurchaseOrderInspectionHeader_DocID", IsUnique = true, Order = 2)]
        public string DocNo { get; set; }

        [Display(Name = "Division"),Required ]
        [ForeignKey("Division")]
        [Index("IX_PurchaseOrderInspectionHeader_DocID", IsUnique = true, Order = 3)]
        public int DivisionId { get; set; }
        public virtual  Division  Division { get; set; }

        [Display(Name = "Site"), Required]
        [ForeignKey("Site")]
        [Index("IX_PurchaseOrderInspectionHeader_DocID", IsUnique = true, Order = 4)]
