...
{
    public class JobOrderCancelBom : EntityBase, IHistoryLog
    {
        [Key]
        public int JobOrderCancelBomId { get; set; }

        [ForeignKey("JobOrderCancelHeader")]
        public int JobOrderCancelHeaderId { get; set; }
        public virtual JobOrderCancelHeader JobOrderCancelHeader { get; set; }

        [ForeignKey("JobOrderCancelLine")]
        public int? JobOrderCancelLineId { get; set; }
        public virtual JobOrderCancelLine JobOrderCancelLine { get; set; }
