...
{
    public class SaleEnquiryHeaderIndexViewModel 
    {
        [Key]
       ...
       public IEnumerable<SaleEnquiryLine>  SaleEnquiryLine {get;set;}
    ...
    public class SaleEnquiryHeaderIndexViewModelForEdit : SaleEnquiryHeaderIndexViewModel
    {
        [Required,MinLength(20)]
        public string LogReason { get; set; }
    }

    public class SaleEnquiryMasterDetailModel
    {
        public int SaleEnquiryHeaderId { get; set; }
        public SaleEnquiryHeaderIndexViewModel SaleEnquiryHeaderIndexViewModel { get; set; }
        public SaleEnquiryHeaderIndexViewModelForEdit SaleEnquiryHeaderIndexViewModelForEdit { get; set; } 
        public List<SaleEnquiryLineIndexViewModel> SaleEnquiryLineIndexViewModel { get; set; }
    }

    public class SaleEnquiryLineListViewModel
    {
        public int SaleEnquiryHeaderId { get; set; }
