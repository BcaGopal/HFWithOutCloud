...
{
    public class RequisitionSettingsViewModel
    {
        ...
        public string OnSubmitMenuName { get; set; }


        [Display(Name = "OnApproveMenu")]
        public int? OnApproveMenuId { get; set; }
        public string OnApproveMenuName { get; set; }

        public int? DefaultReasonId { get; set; }
        public string DeafultReasonName { get; set; }
