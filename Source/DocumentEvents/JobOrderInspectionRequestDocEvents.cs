...
namespace JobOrderInspectionRequestDocumentEvents
{
    public delegate bool DocumentEventHandlerWithReturn(object sender, JobEventArgs EventArgs, ref ApplicationDbContext db);
    public delegate void DocumentEventHandler(object sender, JobEventArgs EventArgs, ref ApplicationDbContext db);
    public class JobOrderInspectionRequestDocEvents
    {       
        ...
        public static bool beforeHeaderSaveEvent(object sender, JobEventArgs Args, ref ApplicationDbContext db)
        {
        ...
        public static void onHeaderSaveEvent(object sender, JobEventArgs Args, ref ApplicationDbContext db)
        {
            if (_onHeaderSave != null)
                _onHeaderSave(sender, Args, ref db);
        }

        public static void afterHeaderSaveEvent(object sender, JobEventArgs Args, ref ApplicationDbContext db)
        {
            if (_afterHeaderSave != null)
                _afterHeaderSave(sender, Args, ref db);
        }

        public static bool beforeHeaderDeleteEvent(object sender, JobEventArgs Args, ref ApplicationDbContext db)
        {
        ...
        public static void onHeaderDeleteEvent(object sender, JobEventArgs Args, ref ApplicationDbContext db)
        {
            if (_onHeaderDelete != null)
                _onHeaderDelete(sender, Args, ref db);
        }

        public static void afterHeaderDeleteEvent(object sender, JobEventArgs Args, ref ApplicationDbContext db)
        {
            if (_afterHeaderDelete != null)
                _afterHeaderDelete(sender, Args, ref db);
        }

        public static bool beforeHeaderSubmitEvent(object sender, JobEventArgs Args, ref ApplicationDbContext db)
        {
        ...
        public static void onHeaderSubmitEvent(object sender, JobEventArgs Args, ref ApplicationDbContext db)
        {
            if (_onHeaderSubmit != null)
                _onHeaderSubmit(sender, Args, ref db);
        }

        public static void afterHeaderSubmitEvent(object sender, JobEventArgs Args, ref ApplicationDbContext db)
        {
            if (_afterHeaderSubmit != null)
                _afterHeaderSubmit(sender, Args, ref db);
        }

        public static bool beforeHeaderReviewEvent(object sender, JobEventArgs Args, ref ApplicationDbContext db)
        {
        ...
        public static void onHeaderReviewEvent(object sender, JobEventArgs Args, ref ApplicationDbContext db)
        {
            if (_onHeaderReview != null)
                _onHeaderReview(sender, Args, ref db);
        }

        public static void afterHeaderReviewEvent(object sender, JobEventArgs Args, ref ApplicationDbContext db)
        {
        ...
        public static bool beforeHeaderPrintEvent(object sender, JobEventArgs Args, ref ApplicationDbContext db)
        {
        ...
        public static void afterHeaderPrintEvent(object sender, JobEventArgs Args, ref ApplicationDbContext db)
        {
            if (_afterHeaderPrint != null)
                _afterHeaderPrint(sender, Args, ref db);
        }

        public static bool beforeLineSaveEvent(object sender, JobEventArgs Args, ref ApplicationDbContext db)
        {
        ...
        public static void onLineSaveEvent(object sender, JobEventArgs Args, ref ApplicationDbContext db)
        {
            if (_onLineSave != null)
                _onLineSave(sender, Args, ref db);
        }

        public static void afterLineSaveEvent(object sender, JobEventArgs Args, ref ApplicationDbContext db)
        {
            if (_afterLineSave != null)
                _afterLineSave(sender, Args, ref db);
        }

        public static bool beforeLineSaveBulkEvent(object sender, JobEventArgs Args, ref ApplicationDbContext db)
        {
        ...
        public static void onLineSaveBulkEvent(object sender, JobEventArgs Args, ref ApplicationDbContext db)
        {
            if (_onLineSaveBulk != null)
                _onLineSaveBulk(sender, Args, ref db);
        }

        public static void afterLineSaveBulkEvent(object sender, JobEventArgs Args, ref ApplicationDbContext db)
        {
        ...
        public static bool beforeLineDeleteEvent(object sender, JobEventArgs Args, ref ApplicationDbContext db)
        {
        ...
        public static void onLineDeleteEvent(object sender, JobEventArgs Args, ref ApplicationDbContext db)
        {
            if (_onLineDelete != null)
                _onLineDelete(sender, Args, ref db);
        }

        public static void afterLineDeleteEvent(object sender, JobEventArgs Args, ref ApplicationDbContext db)
        {
            if (_afterLineDelete != null)
                _afterLineDelete(sender, Args, ref db);
        }

        public static bool beforeWizardSaveEvent(object sender, JobEventArgs Args, ref ApplicationDbContext db)
        {
        ...
        public static void onWizardSaveEvent(object sender, JobEventArgs Args, ref ApplicationDbContext db)
        {
            if (_onWizardSave != null)
                _onWizardSave(sender, Args, ref db);
        }

        public static void afterWizardSaveEvent(object sender, JobEventArgs Args, ref ApplicationDbContext db)
        {
