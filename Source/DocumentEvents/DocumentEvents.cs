...
namespace DocumentEvents
{
    ...
    {     
        ...
        //public static bool beforeHeaderApproveEvent(object sender, JobEventArgs Args, ref ApplicationDbContext db)
        //{
        ...
        //public static void onHeaderApproveEvent(object sender, JobEventArgs Args, ref ApplicationDbContext db)
        //{
        //    if (_onHeaderApprove != null)
        //        _onHeaderApprove(sender, Args, ref db);
        //}

        //public static void afterHeaderApproveEvent(object sender, JobEventArgs Args, ref ApplicationDbContext db)
        //{
    ...
    public class EventModeConstants
    {
