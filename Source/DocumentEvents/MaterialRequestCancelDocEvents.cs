...
namespace MaterialRequestCancelDocumentEvents
{
    ...
    public class MaterialRequestCancelDocEvents 
    {       
        ...
        public static bool beforeHeaderApproveEvent(object sender, StockEventArgs Args, ref ApplicationDbContext db)
        {
        ...
        public static void onHeaderApproveEvent(object sender, StockEventArgs Args, ref ApplicationDbContext db)
        {
            if (_onHeaderApprove != null)
                _onHeaderApprove(sender, Args, ref db);
        }

        public static void afterHeaderApproveEvent(object sender, StockEventArgs Args, ref ApplicationDbContext db)
        {
