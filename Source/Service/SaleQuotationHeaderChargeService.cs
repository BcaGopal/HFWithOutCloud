...
namespace Service
{
    public interface ISaleQuotationHeaderChargeService : IDisposable
    {
        SaleQuotationHeaderCharge Create(SaleQuotationHeaderCharge pt);
        void Delete(int id);
        void Delete(SaleQuotationHeaderCharge pt);
        SaleQuotationHeaderCharge Find(int id);
        IEnumerable<SaleQuotationHeaderCharge> GetPagedList(int pageNumber, int pageSize, out int totalRecords);
        void Update(SaleQuotationHeaderCharge pt);
        SaleQuotationHeaderCharge Add(SaleQuotationHeaderCharge pt);
        IEnumerable<SaleQuotationHeaderCharge> GetSaleQuotationHeaderChargeList();
        Task<IEquatable<SaleQuotationHeaderCharge>> GetAsync();
        Task<SaleQuotationHeaderCharge> FindAsync(int id);
        int NextId(int id);
        int PrevId(int id);
        IEnumerable<HeaderChargeViewModel> GetCalculationFooterList(int HeaderTableId);
    }

    public class SaleQuotationHeaderChargeService : ISaleQuotationHeaderChargeService
    {
        ApplicationDbContext db = new ApplicationDbContext();
        private readonly IUnitOfWorkForService _unitOfWork;
        public SaleQuotationHeaderChargeService(IUnitOfWorkForService unitOfWork)
        {
        ...
        {
            var temp=from p in db.SaleQuotationHeaderCharge
        ...
        public SaleQuotationHeaderCharge Find(int id)
        {
            return (_unitOfWork.Repository<SaleQuotationHeaderCharge>().Find(id));
        }

        public SaleQuotationHeaderCharge Create(SaleQuotationHeaderCharge pt)
        {
            pt.ObjectState = ObjectState.Added;
            _unitOfWork.Repository<SaleQuotationHeaderCharge>().Insert(pt);
        ...
        {
            _unitOfWork.Repository<SaleQuotationHeaderCharge>().Delete(id);
        }

        public void Delete(SaleQuotationHeaderCharge pt)
        {
            _unitOfWork.Repository<SaleQuotationHeaderCharge>().Delete(pt);
        }

        public void Update(SaleQuotationHeaderCharge pt)
        {
            pt.ObjectState = ObjectState.Modified;
            _unitOfWork.Repository<SaleQuotationHeaderCharge>().Update(pt);
        }

        public IEnumerable<SaleQuotationHeaderCharge> GetPagedList(int pageNumber, int pageSize, out int totalRecords)
        {
            var so = _unitOfWork.Repository<SaleQuotationHeaderCharge>()
                .Query()               
        ...
        public IEnumerable<SaleQuotationHeaderCharge> GetSaleQuotationHeaderChargeList()
        {
            var pt = _unitOfWork.Repository<SaleQuotationHeaderCharge>().Query().Get().OrderBy(m=>m.HeaderTableId);

            return pt;
        }

        public SaleQuotationHeaderCharge Add(SaleQuotationHeaderCharge pt)
        {
            _unitOfWork.Repository<SaleQuotationHeaderCharge>().Insert(pt);
            return pt;
        }
        ...
        public int NextId(int id)
        {
            ...
            if (id != 0)
            {
                temp = (from p in db.SaleQuotationHeaderCharge
        ...
        public Task<IEquatable<SaleQuotationHeaderCharge>> GetAsync()
        {
            throw new NotImplementedException();
        }

        public Task<SaleQuotationHeaderCharge> FindAsync(int id)
        {
            throw new NotImplementedException();
        }
    }
