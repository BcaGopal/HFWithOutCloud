IF OBJECT_ID ('[Web].[ProcGetBomForWeavingPlan]') IS NOT NULL
	DROP PROCEDURE [Web].[ProcGetBomForWeavingPlan]	
GO


Create ALTER PROCEDURE [Web].[ProcGetBomForWeavingPlan]
(
...
SELECT H.ProdOrderLineId,H.ProductId,NULL AS Dimension1Id, NULL AS Dimension2Id, NULL AS ProcessId, H.ReqQty AS Qty
